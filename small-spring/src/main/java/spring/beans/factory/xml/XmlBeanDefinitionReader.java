...
public class XmlBeanDefinitionReader extends AbstractBeanDefinitionReader {
    ...
    /**
     *  处理资源加载，把解析后的BeanDefinition 注册到 Bean 容器
     * @param resource
    ...
    /**
     * 实现对xml的读取和元素 Element 解析，获取 Bean 配置以及配置中的 id、name、class、value、ref 信息
     * 把读取出来的配置信息，创建成 BeanDefinition 以及 PropertyValue，最终把 BeanDefinition 注册到 Bean 容器
     * @param inputStream
